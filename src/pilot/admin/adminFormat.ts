...
export type WorkCard = 'safety' | 'reports' | 'overdue' | 'today' | 'requests' | 'verification' | 'reassign' | 'repeat'
export const WORK_CARDS: WorkCard[] = ['safety', 'reports', 'overdue', 'today', 'requests', 'verification', 'reassign', 'repeat']