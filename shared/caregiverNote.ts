...
// 같은 문제 해결 방식과 동일).
const DIFFICULTY_KEYWORDS = ['힘들', '지치', '지쳐', '지쳤', '버거', '벅차', '고민', '난감', '당황']
const HONORIFIC_DIFFICULTY = [
  '힘드시', '힘드셨', '힘들어하시', '힘들어하셨', '지치시', '지치셨', '버거우시', '버거우셨', '벅차하시', '벅차하셨',
  '고민하시', '고민하셨', '난감해하시', '난감해하셨', '당황하시', '당황하셨',
]
